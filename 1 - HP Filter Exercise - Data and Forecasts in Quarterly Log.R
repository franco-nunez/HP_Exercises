...
forecast_log <- read_excel("Inputs\\Combinedq_Chile.xlsx", sheet = 1)


# Convert to time-series:
gdp.log2019q2_f <- ts(forecast_log$log.gdp2019q2, start = c(1986,1), end= c(2020,3),frequency = 4)
gdp.log2019q3_f <- ts(forecast_log$log.gdp2019q3, start = c(1986,1), end= c(2020,4),frequency = 4)
gdp.log2019q4_f <- ts(forecast_log$log.gdp2019q4, start = c(1986,1), end= c(2021,1),frequency = 4)
gdp.log2020q1_f <- ts(forecast_log$log.gdp2020q1, start = c(1986,1), end= c(2021,2),frequency = 4)
gdp.log2020q2_f <- ts(forecast_log$log.gdp2020q2, start = c(1986,1), end= c(2021,3),frequency = 4)
gdp.log2020q3_f <- ts(forecast_log$log.gdp2020q3, start = c(1986,1), end= c(2021,4),frequency = 4)
gdp.log_f <- ts(forecast_log$log.gdp, start = c(1986,1), end= c(2022,1),frequency = 4)
# Multiply by 100
