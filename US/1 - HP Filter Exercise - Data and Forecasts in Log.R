...
forecast_log <- read_excel("Inputs\\Combined.xlsx", sheet = 1)


# Convert to time-series:
gdp.log2014_f <- ts(forecast_log$log.gdp2014, start = c(1929), end= c(2019),frequency = 1)
gdp.log2015_f <- ts(forecast_log$log.gdp2015, start = c(1929), end= c(2020),frequency = 1)
gdp.log2016_f <- ts(forecast_log$log.gdp2016, start = c(1929), end= c(2021),frequency = 1)
gdp.log2017_f <- ts(forecast_log$log.gdp2017, start = c(1929), end= c(2022),frequency = 1)
gdp.log2018_f <- ts(forecast_log$log.gdp2018, start = c(1929), end= c(2023),frequency = 1)
gdp.log2019_f <- ts(forecast_log$log.gdp2019, start = c(1929), end= c(2024),frequency = 1)
gdp.log_f <- ts(forecast_log$log.gdp, start = c(1929), end= c(2025),frequency = 1)
