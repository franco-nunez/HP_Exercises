...
#Plot cycles
graph_cycle(tit=title_c, subt=subtitle_c, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "1 year", axis_labels= "%Y")
...
#Plot tendencies
graph_trend(tit=title_t, subt=subtitle_t, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "1 year", axis_labels= "%Y")
...
#Plot cycles
graph_cycle(tit=title_c, subt=subtitle_c, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "6 months", axis_labels= "%Y-%b")
...
#Plot tendencies
graph_trend(tit=title_t, subt=subtitle_t, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "6 months", axis_labels= "%Y-%b")
...
# Subset
# Select start dates for the graphs
year=1950 # Suggested: 2013 for Annual, 2017 or 2018 for Quarterly
quarter=1 #1 for annual data
...
#Plot cycles
graph_cycle(tit=title_c, subt=subtitle_c, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "5 years", axis_labels= "%Y")
...
#Plot tendencies
graph_trend(tit=title_t, subt=subtitle_t, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "5 years", axis_labels= "%Y")
