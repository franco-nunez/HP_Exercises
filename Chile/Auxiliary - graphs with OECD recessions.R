...
# Define ####
# Load data
recession <- read_excel("Inputs\\OECDrecessions.xlsx")
...
# Call 
source("Auxiliary - OECD+FRED recessions.R")

# Function ####
library(ggplot2)
graph_cycle_oecd = function(name, tit, subt, size_text=18, font_text="Times New Roman", size_lines=1.25, axis_breaks = "6 months", axis_labels= "%Y-%b"){
