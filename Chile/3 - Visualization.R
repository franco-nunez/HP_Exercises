...
year=1960 # Suggested: 2013 for Annual, 2017 or 2018 for Quarterly
...
#Plot cycles
graph_cycle(tit=title_c, subt=subtitle_c, axis_breaks = "5 years", axis_labels= "%Y")
...
#Plot tendencies
graph_trend(tit=title_t, subt=subtitle_t, axis_breaks = "5 years", axis_labels= "%Y")
...
# Subset
# Select start dates for the graphs
year=1986 # Suggested: 2013 for Annual, 2017 or 2018 for Quarterly
quarter=1 #1 for annual data
...
#Plot cycles
graph_cycle(tit=title_c, subt=subtitle_c, axis_breaks = "1 year", axis_labels= "%Y")
...
#Plot tendencies
graph_trend(tit=title_t, subt=subtitle_t, axis_breaks = "1 year", axis_labels= "%Y")
